...
# Sets up FastAPI in a function so we can create it in the tests
def create_app():
    ...
    async def get_spocs(request: Request):
        ...
        return call(request.client.host, req_params, required_params, optional_params=optional_params)
    ...
    def call(client_ip, req_params, required_params, optional_params=None):
